...
| `browser-use`       | Automate browser interactions, tests, and screenshots                                                                                                                 |
...
| `codebase-online-researcher` | Fetch up-to-date docs and authoritative sources from the web (uses `browser-use`)                     |
...
| `debugger`                   | Debug errors, test failures, and unexpected behavior (uses `tdd` and `browser-use`)                   |
